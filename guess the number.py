...
def enternumber (randomnumber_):
    ...
    if userinput == randomnumber_:
        if guesses == 1:
            ...
            print (Fore.RESET)
            time.sleep (2)
            print (f"The number generated by the game is {randomnumber_} and you've guessed it for {guesses} time.")
            time.sleep (2)
            ...
            print (Fore.RESET)
            time.sleep (2)
            print (f"The number generated by the game is {randomnumber_} and you've guessed it for {guesses} times.")
            time.sleep (2)
            print ("That's all, I hope you enjoyed this game.")
            time.sleep (2)
            print ("Thank you for playing and I hope to see you again!")
