...
def lotterytime (randomnumbers):
    while True:
        ...
        lottonum = threenumbers
        user.append (lottonum)
        ...
        if user == randomnumbers:
            break
                ...
                time.sleep (2)
                print (f"The numbers that you entered are {threenumbers} while the numbers generated by the program are {randomnumbers}.")
                time.sleep (2)
